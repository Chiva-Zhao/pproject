...
# 在定义类的时候， Python 允许我们使用metaclass关键字参数来指定特定的元类。
# 例如使用抽象基类：
...
class Spam(metaclass=ABCMeta, debug=True, synchronize=True):
    pass


# 为了使元类支持这些关键字参数，你必须确保在 prepare () , new () 和
# init () 方法中都使用强制关键字参数。就像下面这样：
